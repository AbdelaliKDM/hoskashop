...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::prefix('category')->middleware('role:0,1,2,3')->group(function () {
    ...
    Route::prefix('subcategory')->middleware('role:0,1,2,3')->group(function () {
    ...
    Route::prefix('unit')->middleware('role:0,1,2,3')->group(function () {
  ...
  Route::prefix('admin')->middleware('role:0,1')->group(function () {
    ...
    Route::prefix('product')->group(function () {
      Route::middleware('role:0,1,2,3,5')->group(function () {
    ...
    Route::prefix('image')->middleware('role:0,1,2,3,5')->group(function () {
    ...
    Route::prefix('video')->middleware('role:0,1,2,3,5')->group(function () {
    ...
    Route::prefix('discount')->middleware('role:0,1,2,3,5')->group(function () {
